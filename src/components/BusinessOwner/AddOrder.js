                ...
                <form className="needs-validation" onSubmit={handleSubmit} noValidate>
                    <div className="row g-4 mb-4">
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control mt-3 text-secondary" id="cName" placeholder="Enter Customer Name" value={formData.cName} onChange={handleChange} required />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="cEmail" className="form-label fw-semibold">Customer Email</label>
                            <input type="email" className="form-control text-secondary mt-3" id="cEmail" placeholder="Enter Customer Email" value={formData.cEmail} onChange={handleChange} required />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="cPhone" className="form-label fw-semibold">Customer Phone</label>
                            <input type="number" className="form-control text-secondary mt-3" id="cPhone" placeholder="Enter Customer Phone" value={formData.cPhone} onChange={handleChange} required />
                        </div>
                    </div>
                    ...
                    <div className="row g-4 mb-4">
                        <div className="col-md-4">
                            ...
                            <input type="text" className="form-control text-secondary mt-3" id="pName" placeholder="Enter Product Name" value={formData.pName} onChange={handleChange} required />
                        </div>
                        <div className="col-md-4">
                            <label htmlFor="category" className="form-label fw-semibold">Product Category</label>
                            <select className="form-select text-secondary mt-3" id="category" value={formData.category} onChange={handleChange} required>
                        ...
                        <div className="col-md-4">
                            ...
                            <input type="number" className="form-control text-secondary mt-3" id="amount" placeholder="Enter Total Amount" value={formData.amount} onChange={handleChange} required />
                        </div>
                    </div>
                    ...
                    <div className="row g-4 mb-4">
                        <div className="col-md-4">
                            ...
                            <input type="number" className="form-control text-secondary mt-3" id="ounits" placeholder="Enter Number of Units" value={formData.ounits} onChange={handleChange} required />
                        </div>
                        <div className="col-md-4">
                    ...
                    <div className="row g-4 mb-4">
                        <div className="col-md-3">
                            ...
                            <select className="form-select text-secondary mt-3" id="status" value={formData.status} onChange={handleChange} required>
                        ...
                        <div className="col-md-3">
                            ...
                            <select className="form-select text-secondary mt-3" id="dStatus" value={formData.dStatus} onChange={handleChange} required>
                        ...
                        <div className="col-md-3">
                            ...
                            <select className="form-select text-secondary mt-3" id="pAvail" value={formData.pAvail} onChange={handleChange} required>
                    ...
                    <div className="row g-4 mb-4">
                        <div className="col-12">
                            ...
                            <textarea className="form-control text-secondary mt-3" id="cAddress" rows="3" placeholder="Enter Delivery Address" value={formData.cAddress} onChange={handleChange} required></textarea>
                        </div>
                    </div>
                    ...
                    <div className="row g-4 mb-4">
                        <div className="col-12">
                            ...
                            <textarea className="form-control text-secondary mt-3" id="desc" rows="3" placeholder="Enter Additional Notes" value={formData.desc} onChange={handleChange}></textarea>
                        </div>
                    </div>

                    <div className="row mt-5">
                        <div className="col-12 d-flex justify-content-start">
                            <button type="submit" className="btn btn-custom-purple btn-lg me-3 shadow-sm">Add Order</button>
