            ...
            <div className="container-fluid py-4">
                <div className="row mb-4 mx-3">
                    <div className="col-12">
                        <h1 className="display-5 fw-normal">Edit Supplier Order</h1>
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="d-flex gap-2">
                                        <button type="submit" className="btn btn-custom-purple">
                                            <i className="bi bi-check-lg me-2"></i> Update Order
                                        </button>
                                        <button type="button" className="btn btn-secondary" onClick={() => navigate(`/dashboard/supplierordes/${supplierId}`)}>
