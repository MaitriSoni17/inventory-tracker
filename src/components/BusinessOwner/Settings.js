...
const Settings = (props) => {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      if (res.ok) {
        props.showAlert?.('Account deleted permanently', 'success');
  ...
  const handleApplyTheme = (theme) => {
    try {
      ...
      props.showAlert?.('Error applying theme', 'danger');
    }
  };
                ...
                <div className="preference-group">
                  ...
                  <div className="theme-selector">
                    <div className="theme-options">
                      <button
                        className={`theme-btn light-theme ${preferences.theme === 'light' ? 'active' : ''}`}
                      ...
                      <button
                        className={`theme-btn dark-theme ${preferences.theme === 'dark' ? 'active' : ''}`}
                      ...
                      <button
                        className={`theme-btn auto-theme ${preferences.theme === 'auto' ? 'active' : ''}`}
                    ...
                    <p className="theme-description">Current theme: <strong>{preferences.theme}</strong></p>
                  </div>
                </div>
